...
const (
	User_GetUser_FullMethodName = "/example.base.svr.user.v1.User/GetUser"
)
...
var User_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "example.base.svr.user.v1.User",
	...
	Metadata: "buf_proto_example/proto/example/base/svr/user/v1/user.proto",
}
